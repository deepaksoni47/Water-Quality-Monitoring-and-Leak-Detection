      ...
      <div className="flex items-start justify-between mb-4">
        ...
        {info && (
          <div className="group relative">
            ...
            <div className="absolute right-0 top-6 bg-gray-900 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10 border border-gray-700">
              {info}
            </div>
          </div>
        )}
